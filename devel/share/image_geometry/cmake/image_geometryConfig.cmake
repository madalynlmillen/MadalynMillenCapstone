...
if("TRUE" STREQUAL "TRUE")
  set(image_geometry_SOURCE_PREFIX /home/kinova/MillenCapstone/MadalynMillenCapstone/src/vision_opencv-melodic/image_geometry)
  set(image_geometry_DEVEL_PREFIX /home/kinova/MillenCapstone/MadalynMillenCapstone/devel)
  ...
  set(image_geometry_INSTALL_PREFIX /home/kinova/MillenCapstone/MadalynMillenCapstone/install)
...
if(NOT "/home/kinova/MillenCapstone/MadalynMillenCapstone/src/vision_opencv-melodic/image_geometry/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv " STREQUAL " ")
  set(image_geometry_INCLUDE_DIRS "")
  set(_include_dirs "/home/kinova/MillenCapstone/MadalynMillenCapstone/src/vision_opencv-melodic/image_geometry/include;/opt/ros/kinetic/include/opencv-3.3.1-dev;/opt/ros/kinetic/include/opencv-3.3.1-dev/opencv")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_geometry' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/kinova/MillenCapstone/MadalynMillenCapstone/src/vision_opencv-melodic/image_geometry/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/kinova/MillenCapstone/MadalynMillenCapstone/devel/lib;/home/kinova/CHRISLab/devel/lib;/opt/ros/kinetic/lib)
